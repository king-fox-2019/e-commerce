              ...
              <b-navbar-nav class="ml-auto">
                  <b-nav-form style="margin-right:20px;">
                    <form @submit.prevent="search">
                      <b-form-input size="sm" class="mr-sm-2" v-model="keyword" placeholder="Search" ></b-form-input>
                      <button style=
                      "border:none
                      padding: 0;
...
export default {
  ...
  methods : {
    ...
    search(){
      ...
      this.$store.commit('FILTER_PRODUCT',this.keyword)
      if(this.$route.path != '/'){
        this.$router.push('/')
      }
