    ...
    static async createTransaction(req, res, next) {
        try {
            ...
            for (let cart in cartTransaction) {
                ...
                value += cartTransaction[cart].product_id.price * cartTransaction[cart].product_id.quantity
            }
            ...
            Transaction.create({
                ...
                .then(num => {
                    nodemailer(value.toLocaleString(), req.loggedUser.email, req.loggedUser.username)
